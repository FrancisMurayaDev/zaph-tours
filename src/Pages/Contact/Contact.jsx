...
function ContactDetails() {
  return (
    <div className="contact-details">
      <p>
        {" "}
        <strong>Email:</strong> email@zaphtours.com
      </p>
      <p>
        {" "}
        <strong>Phone:</strong> 0789123456
      </p>
      <p>
        {" "}
    ...
    <div className="contact-footer">
      <div className="work-social">
        <div className="office-hours">
          <h3 className="contacts-details-title">Office Hours:</h3>
          <p>
            {" "}
          ...
          <p>
            {" "}
            <strong>Saturdays :</strong> 9AM - 2PM
          </p>
          <p>
            {" "}
